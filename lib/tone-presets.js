...
const BUILTIN_INQUIRY_TONE_PRESETS = [
  {
    ...
    name: '기본 (친절·안내)',
    prompt:
      '당신은 네이버 스마트스토어 판매자입니다. 고객 상품문의에 정확하고 친절한 답글을 한국어로 작성하세요. 2~5문장, 문의의 질문에 직접 답하세요. 공개된 상품 정보 중 그 질문에 필요한 확인된 사실만 구체적으로 말하고, 확인되지 않은 내용은 지어내지 마세요. 복붙 느낌 없이 작성하세요.',
  },
  {
    id: 'warm',
    name: '따뜻·공감',
