  ...
  return new Promise((resolve) => {
    ...
    card.innerHTML = `
      ...
      <div style="margin-bottom:20px;">
        <div style="font-size:13px;font-weight:700;color:#1d4ed8;margin-bottom:6px;">새 말투</div>
        <div style="font-size:12px;color:#64748b;margin-bottom:8px;">저장하기 전에 아래 내용을 고칠 수 있어요.</div>
        ...
        <div class="ss-style-confirm-error" hidden style="margin-top:8px;font-size:12px;color:#b91c1c;">말투 내용을 입력해 주세요.</div>
      </div>
...
async function confirmAndApplyLearnedStyle(settings, context, response, extraSettingsPatch = {}) {
  ...
  const choice = await showStyleApplyConfirm({
    ...
    subtitle: snapshot.configured
      ? '지금 쓰는 말투가 있어요. 아래 내용을 고친 뒤 저장할지 선택하세요.'
      : 'AI가 만든 말투입니다. 마음에 들면 저장, 고치고 싶으면 아래에서 수정하세요.',
